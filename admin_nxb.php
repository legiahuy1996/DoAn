                                    ...
                                    foreach ($listnxb as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$value['SDT']?></td>
                                             ...
                                             <td colspan="2"><a href="SuaNXB.php?manxb=<?=$value['MaNXB']?>" class="btn btn-warning"> Sửa </a> <a  href="XuLyXoaNXB.php?manxb=<?=$value['MaNXB']?>" class="btn btn-danger">Xoá</a></td>
                                        </tr>
