...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sửa chi tiết</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="XuLySuaChitiet.php?mact=<?=$chitiet['MaChiTietDonHang']?>" method="post" >
                                      
                                        <div class="form-group">
                                           <label>Mã đơn hàng</label>
                                            <input name="madonhang" class="form-control" value="<?=$chitiet['Madonhang']?>" readonly >
                                        </div>
                                            <div class="form-group">
                                           <label>Mã sách</label>
                                            <input name="masach" class="form-control" value="<?=$chitiet['MaSach']?>" >
                                        </div>
                                            <div class="form-group">
                                           <label>Số lượng</label>
                                            ...
                                            <div class="form-group">
                                           <label>Đơn giá</label>
                                            <input name="dongia" type="number" class="form-control" value="<?=$chitiet['Dongia']?>" >
                                        </div>
