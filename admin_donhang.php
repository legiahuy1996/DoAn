        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="Themdonhang.php" class="btn btn-primary">Thêm đơn hàng</a>
                </div>
                <div id="Them"></div>
                <!-- /.col-lg-12 -->
            </div>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $m_admin= new M_admin();
                                    $listdonhang = $m_admin->getlistdonhang();
                                    foreach ($listdonhang as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$value['NgayDat']?></td>
                                            <td><?php if($value['TinhTrangGiaoHang']==1) echo "Đang được giao"?></td>
                                            <td><?=$value['DiaChi']?></td>
                                           
                                            <td><?=$value['PhuongThucThanhToan']?></td>
                                          
                                            <td colspan="2"><a href="Suadonhang.php?Madonhang=<?=$value['Madonhang']?>" class="btn btn-warning"> Sửa </a> <a  href="chitietdonhang.php?Madonhang=<?=$value['Madonhang']?>" class="btn btn-primary">Chi tiết</a></td>
                                        </tr>
