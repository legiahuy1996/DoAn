            ...
            <div class="row">
                <div class="col-lg-12">
                  <h1 class="page-header">Trang quản trị</h1>
                    <a href="ThemChuDe.php" class="btn btn-primary">Thêm chủ đề</a>
                </div>
                <div id="Them"></div>
                <!-- /.col-lg-12 -->
            </div>
                                    ...
                                    foreach ($listsach as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$value['tenchude']?></td>
                                             ...
                                             <td colspan="2"><a href="SuaChude.php?machude=<?=$value['machude']?>" class="btn btn-warning"> Sửa </a> <a  href="XuLyXoaChude.php?machude=<?=$value['machude']?>" class="btn btn-danger">Xoá</a></td>
                                        </tr>
