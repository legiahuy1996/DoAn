            ...
            <div class="row">
                <div class="col-lg-12">
                  <h1 class="page-header">Trang quản trị</h1>
                    <a href="ThemTacgia.php" class="btn btn-primary">Thêm tác giả</a>
                </div>
                <div id="Them"></div>
                <!-- /.col-lg-12 -->
            </div>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $m_admin= new M_admin();
                                    $listtacgia = $m_admin->getlisttacgia();
                                    ...
                                    foreach ($listtacgia as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$value['TieuSu']?></td>
                                             ...
                                             <td colspan="2"><a href="Suatacgia.php?matacgia=<?=$value['MaTacGia']?>" class="btn btn-warning"> Sửa </a> <a  href="XuLyXoaTacgia.php?matacgia=<?=$value['MaTacGia']?>" class="btn btn-danger">Xoá</a></td>
                                        </tr>
