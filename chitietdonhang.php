...
?>
                    <a href="Themchitiet.php?madonhang=<?=$madonhang?>" class="btn btn-primary">Thêm chi tiết đơn hàng</a>
                </div>
                <div id="Them"></div>
                <!-- /.col-lg-12 -->
            </div>
...
<?php
                                    foreach ($listchitiet as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><a href="Suachitietdonhang.php?mact=<?=$value['MaChiTietDonHang']?>" class="btn btn-warning"> Sửa </a> <a  href="Xoachitietdonhang.php?mact=<?=$value['MaChiTietDonHang']?>" class="btn btn-danger">Xoá</a></td>
                                        </tr>
